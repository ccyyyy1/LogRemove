...
public class MyProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        if(removeClass == null || "".equals(removeClass))
            return true;
...
//                    System.out.println("each.getSimpleName(): " + each.getSimpleName());
            ...
            log(sb.toString());
            log("[ " + count + " ] "+removeClass+"/"+removeClassSimple+" removed.");
        }
    ...
    boolean isRemoveClassFull(String name) {
        return removeClass != null && !"".equals(removeClass) && removeClass.equals(name);
    }

    boolean isRemoveClassSimple(String name) {
        return removeClassSimple != null && !"".equals(removeClassSimple) && removeClassSimple.equals(name);
    }
    ...
    public synchronized void init(ProcessingEnvironment processingEnvironment) {
        ...
        removeClass = processingEnvironment.getOptions().get("REMOVE_LOG_CLASS");
        //内部类 com.A$B
        //内部类 com.A.B$C.D
        ...
        try {
            removeClassSimple = removeClass.substring(removeClass.lastIndexOf('.') + 1);
        } catch (Exception e) {
            e.printStackTrace();
        }
